      ...
      <div className="w-full max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col items-start">
            <img src="/path-to-nike-logo.png" alt="Nike logo with Just Do It tagline" className="w-32" />
          ...
          <div className="flex flex-col space-y-2">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/nike" target="_blank" rel="noopener noreferrer" aria-label="Nike on Facebook" className="text-gray-400 hover:text-white">
                <FontAwesomeIcon icon={faFacebookF} />
              </a>
              <a href="https://twitter.com/nike" target="_blank" rel="noopener noreferrer" aria-label="Nike on Twitter" className="text-gray-400 hover:text-white">
                <FontAwesomeIcon icon={faTwitter} />
              </a>
              <a href="https://www.instagram.com/nike" target="_blank" rel="noopener noreferrer" aria-label="Nike on Instagram" className="text-gray-400 hover:text-white">
                <FontAwesomeIcon icon={faInstagram} />
              </a>
              <a href="https://www.youtube.com/user/nike" target="_blank" rel="noopener noreferrer" aria-label="Nike on YouTube" className="text-gray-400 hover:text-white">
